...
#define Gate_6 5
#define Credit 6
#define Football_Stage 7
#define Acoustics_Building 8
#define Civil_Building 9


#define Civil_Compass_Port PortD
#define HallA_Compass_Port PortD
#define Acoustics_Building_Compass_Port PortB
#define Gate2_Compass_Port PortB

#define Civil_Compass_Pin Pin3
#define HallA_Compass_Pin Pin6
#define Acoustics_Building_Compass_Pin Pin2
#define Gate2_Compass_Pin Pin3
